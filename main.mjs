...
function createTables() {
	...
	sql.query("CREATE TABLE IF NOT EXISTS zones (id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, name VARCHAR(20) NOT NULL, creation DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, position LONGTEXT NOT NULL)") // canvas zones table
}
